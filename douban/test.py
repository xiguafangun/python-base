...
response = requests.get('https://movie.douban.com/review/12758206/', headers=headers)
...
#     async with httpx.AsyncClient() as client:
#         r = await client.get(
#             'http://api.goubanjia.com/dynamic/get/dbb7c6b79128cca9ceec1d03e89e68ab.html?sep=3'
#         )
#     import ipdb
